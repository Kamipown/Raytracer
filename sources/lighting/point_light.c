...
/*   Updated: 2016/11/14 03:19:33 by vmontagn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	lambert_point(t_env *e, t_lambert *lamb)
{
	...
	//if (lamb->obj && lamb->obj->type != PLANE)
	//	vec_unrotate(&e->scene.light_ray.dir, lamb->obj->rot);
...
//	e->scene.light_ray.dir = vec_mul_d(lamb->dist, 1 / lamb->t);
